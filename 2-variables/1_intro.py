...
We are assigning the string value 'Erlich Bachman' to the variable name.
...
Here, we are assigning the number value 70 to the variable xp. Then, we are reassigning the integer value 80 to the same variable. 
And printing it out.
"""
...
## Float
A floating-point number, or a float, is a decimal number. It can be used to represent fractions or precise measurements.ù
If you were measuring the length and width of the couch, calculating the test score percentage, or storing
a baseball player’s batting average, we would use a float instead of an int.
